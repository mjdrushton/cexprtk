 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      if (!(likely(PyBytes_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_1)->tp_name), 0))) __PYX_ERR(0, 310, __pyx_L3_error)
 ...
 */
      ...
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      if (!(likely(PyBytes_CheckExact(__pyx_t_6))||((__pyx_t_6) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_6)->tp_name), 0))) __PYX_ERR(0, 317, __pyx_L5_except_error)
 ...
 */
  ...
  __pyx_codeobj__7 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__6, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_cexprtk__cexprtk_pyx, __pyx_n_s_evaluate_expression, 42, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__7)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
/* CIntToPy */
static CYTHON_INLINE PyObject* __Pyx_PyInt_From_enum__exprtk_3a__3a_parser_3c_double_3e__3a__3a_unknown_symbol_resolver_3a__3a_usr_symbol_type(enum exprtk::parser<double>::unknown_symbol_resolver::usr_symbol_type value) {
    const enum exprtk::parser<double>::unknown_symbol_resolver::usr_symbol_type neg_one = (enum exprtk::parser<double>::unknown_symbol_resolver::usr_symbol_type) ((enum exprtk::parser<double>::unknown_symbol_resolver::usr_symbol_type) 0 - (enum exprtk::parser<double>::unknown_symbol_resolver::usr_symbol_type) 1), const_zero = (enum exprtk::parser<double>::unknown_symbol_resolver::usr_symbol_type) 0;
    const int is_unsigned = neg_one > const_zero;
    if (is_unsigned) {
